...
st.set_page_config(
    page_title="EcoAir Predictor",
    page_icon="notebooks/warning.png",
    layout="wide",
...
def main():
    ...
    st.title("Global Air Pollution Forecasting Model")
    st.markdown("""
    This application generating accurate PM2.5 AQI predictions, the system also analyzes 
    trends in air pollution patterns across different regions. By leveraging historical datasets 
    and advanced regression models, the application provides insights into how environmental factors, 
    such as temperature, humidity, and industrial activity, influence overall air quality. 
    This helps users and policymakers make informed decisions toward improving environmental health 
    and sustainability.
    """)
    
    # Sidebar for inputs
    st.sidebar.markdown("<h3 style='text-decoration: underline;'>Input Parameters</h3>", unsafe_allow_html=True)
    ...
    if st.sidebar.button("Predict PM2.5 AQI", type="primary"):
        ...
        with col2:
            st.markdown("<h3 style='padding-left: 50px;'>Linear Regression Prediction</h3>", unsafe_allow_html=True)
    ...
    # Information section
    st.markdown("---")
    st.markdown("<h3 style='text-decoration: underline;'>About the Models</h3>", unsafe_allow_html=True)
